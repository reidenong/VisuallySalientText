...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrained_model', default='./Models/PretrainedModels/80.7_T2T_ViT_t_14.pth.tar', type=str, help='load Pretrained model')
    ...
    parser.add_argument('--trainset', default='OCSD/OCSD-TR', type=str, help='Training set')
    parser.add_argument('--save_model_dir', default='Models/Checkpoints/', type=str, help='save model path')

    # test
    parser.add_argument('--Testing', default=True, type=bool, help='Testing or not')
    parser.add_argument('--save_test_path_root', default='Predictions/', type=str, help='save saliency maps path')
    parser.add_argument('--test_paths', type=str, default='OCSD/OCSD-TE')
